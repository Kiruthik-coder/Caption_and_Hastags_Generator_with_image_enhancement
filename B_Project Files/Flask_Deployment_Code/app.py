...
"""def caption_gen(prmpt,prp,mod,sl):
    openai.api_key = "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"
    model_engine = "text-davinci-003"
    prompt = "generate 5 "+sz(sl)+" trending "+mood(mod)+" captions about "+prmpt+" in "+perp(prp)+"way"
    ...
    prompt = "generate 5 trending "+mood(mod)+" hashtags about "+response+" in list formate"
    hashtags = openai.Completion.create(engine=model_engine,prompt=prompt,max_tokens=1024,n=1,stop=None,temperature=0.5,)
